...
save_folder = r"/home/babyrd/branches/Personal/results/coupling_sweep/"  # or "./results" for relative paths
...
EL  = .091
EC  = 1.083
g_n = float(sys.argv[4])
g_phi = 1j * float(sys.argv[5])
f_r = 6.627
coupling_type = "mixed"
chain_mode = False
